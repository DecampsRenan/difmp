...
export interface RunModel {
  ...
  readonly cancellation?: { readonly reason: string; readonly source: string }
  ...
  readonly fixture?: {
    ...
    readonly cleaned?: { readonly cleanupsRun: number; readonly timedOut: boolean }
  }
  ...
  readonly stalls: ReadonlyArray<{ readonly seq: number; readonly reason: string; readonly repeatedActions: number }>
...
export const emptyRunModel: RunModel = {
  lastSeq: 0,
  applied: 0,
  duplicates: 0,
  malformed: 0,
  ...
  artifacts: [],
  observationCount: 0,
  model: { started: 0, finished: 0, inputTokens: 0, outputTokens: 0, verifierTokens: 0 },
  actionCount: 0,
  budgetBreaches: [],
  stalls: [],
  errors: [],
...
export const isFinished = (m: RunModel): boolean => m.status !== "running"
