...
export const recordAction = (state: ActionGuidanceState): ActionGuidanceStep => {
  ...
  const next: ActionGuidanceState = {
    used,
    guidance: state.guidance,
    notified: state.notified || crossing,
  };
...
export const guidanceExceeded = (state: ActionGuidanceState): boolean =>
  state.used > state.guidance;
