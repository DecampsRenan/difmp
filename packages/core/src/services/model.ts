...
export type PromptPart =
  ...
  | { readonly type: "toolCall"; readonly id: string; readonly name: string; readonly params: unknown }
  | {
...
export class ModelProvider extends Context.Service<ModelProvider, {
