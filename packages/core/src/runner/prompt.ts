...
const descriptions: Readonly<Record<ToolName, string>> = {
  observe:
    "Take a fresh observation of the page. Returns an observationId and the element refs valid with it.",
  navigate:
    "Navigate to an absolute URL. Rejected unless the origin is in the configured allow-list.",
  ...
  finish:
    "Declare the scenario walkthrough complete. This triggers final verification; it never decides success.",
};
