...
import { assertUniqueScenarioIds, discoverSpecs, parseDurationMs, parseSpec, resolveConfig } from "../src/index.js"
...
describe("SpecLoader parsing", () => {
  ...
  it.effect("reads expectations from a Markdown section and keeps the paragraph as one criterion", () =>
    Effect.gen(function*() {
